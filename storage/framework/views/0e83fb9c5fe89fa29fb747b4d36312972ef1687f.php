		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					<!------------------------------------------>
					<form class="form-horizontal" action="<?php echo e(route('GCTG')); ?>" method="GET" id="recherche">
                    ...
                    <!------------------------------------------->
					<form class="form-horizontal" method="post" action="<?php echo e(route('SCTG')); ?>" id="regle">
										<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
					...
					<a class="btn-warning dropdown-item " id="valid" href="<?php echo e(route('GRTG')); ?>"
						...
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td style="vertical-align:middle; text-align: center;"><?php echo e($comp->compteGroupe); ?> CFA</td>
	    ...
	    $(function () {
            ...
            if(id.substr(-4, 4) == "reje"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '<form class="form-horizontal" method="post" action="<?php echo e(route("RCTG")); ?>">' +
                        '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
            ...
            if(id.substr(-4, 4) == "conf"){
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '</div>    </div>' +
                    '<div class="modal-footer">   ' +
                    '<button type="button" class="btn btn-warning btn-sm waves-effect waves-light" style="float:left; color:white;"><a href="<?php echo e(route("listCommConfirmG")); ?>">' +
