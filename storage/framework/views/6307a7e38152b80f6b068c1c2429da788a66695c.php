...
<?php if(in_array("add_region", session("auto_action"))): ?>
			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="<?php echo e(route('addG')); ?>"  enctype="multipart/form-data" >
             ...
             <input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> <!-- Limite 5Mo -->
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-6">
								<label for="inp-type-2" style="vertical-align:middle;" class="col-sm-12 ">Chef régional :</label>
								<div class="col-sm-12">
					...
					<script>		
						...
						y.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "<?php echo e(route('listG')); ?>?check="+search+"&rec=1", true);
							xhr.send(null);
						...
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							<thead>
								<tr>
									...
									<th class="textcenter" data-priority="1">Chef régional</th>
