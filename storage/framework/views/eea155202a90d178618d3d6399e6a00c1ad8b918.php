				...
				<div class="row small-spacing">  
					...
					<script>		
						...
						elt.addEventListener('change', function () {
							...
							xhr.open("GET", "<?php echo e(route('listdocument')); ?>?check="+this.value+"&rec=1", true);
							xhr.send(null);
						...
						x.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "<?php echo e(route('listdocument')); ?>?check="+moisch+"&rec=1", true);
							xhr.send(null);
							xhr.onreadystatechange = function() {
							    if (xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0)) {
							        readData(xhr.responseText); // Données textuelles récupérées
							...
							<tbody >
								...
								<tr>
									<td data-priority="1" style="vertical-align:middle; text-align: center;">
									    <?php echo e(App\Providers\InterfaceServiceProvider::LibelleUser($list[$i]->user_action)); ?></td>
									
									<td style="vertical-align:middle; text-align: center;">
									    
										<p id="libelle" style=""> <?php echo e($list[$i]->libelleTrace); ?> </p>
									</td> 
