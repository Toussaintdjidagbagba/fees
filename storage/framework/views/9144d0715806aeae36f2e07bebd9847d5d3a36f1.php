	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
		...
		<div class="box-content bordered info js__card"> 
			...
			<h4 class="box-title with-control">
				...
				Liste Commissions <?php echo e(utf8_encode(strtoupper(strftime('%B %Y')))); ?> calculées NSIA : 
			<span class="controls">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					<div id="ref">
						Ref <b style="color:#001e60">SP</b>/<?php echo e($sigle); ?>

					</div>
					<?php if(sizeof($list) != 0): ?>
					    <?php if(in_array("confirm_sp_com", session("auto_action"))): ?>
					    ...
					    <?php if(in_array("other_operation_sp_com", session("auto_action"))): ?>
					...
					<?php endif; ?>
					<!------------------------------------------>
					<form class="form-horizontal" action="<?php echo e(route('listCom')); ?>" method="GET" id="recherche">
						...
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							<thead>
								<tr>
									...
									<th data-priority="1" style="vertical-align:middle;text-align: center;">Montant CEQP</th>
									<th data-priority="1" style="vertical-align:middle;text-align: center;">Montant Inspection</th>
									<th data-priority="1" style="vertical-align:middle;text-align: center;">Montant RG</th>
									<th data-priority="1" style="vertical-align:middle;text-align: center;">Montant CD</th>
							...
							<tbody id="data">
								...
								<tr>
									<!--td style="vertical-align:middle; text-align: center;"><?php echo e($com->Commission); ?></td-->
									...
									<?php if($com->mont != $com->montSun && $com->sch != "NOUVEAU" && $com->montSun != null): ?>
										<td style="vertical-align:middle; text-align: center; background: #ffb0b0;" title="Commission non concordante. Montant Sunshine (<?php echo e($com->montSun); ?>)">
										  	<?php echo e(number_format($com->mont, 0, '.', ' ')); ?>
									...
									<?php endif; ?>
									<td style="vertical-align:middle; text-align: center;">
										<?php echo e(number_format($com->montceq, 0, '.', ' ')); ?>

									</td>
									<td style="vertical-align:middle; text-align: center;">
										<?php echo e(number_format($com->montins, 0, '.', ' ')); ?>

									</td>
									<td style="vertical-align:middle; text-align: center;">
										<?php echo e(number_format($com->montrg, 0, '.', ' ')); ?>

									</td>
									<td style="vertical-align:middle; text-align: center;">
										<?php echo e(number_format($com->montcd, 0, '.', ' ')); ?>

									</td>
									<!--td style="vertical-align:middle; text-align: center;"><?php echo e($com->Garantie); ?></td-->
									<td style="vertical-align:middle; text-align: center;" title="<?php echo e(App\Providers\InterfaceServiceProvider::infomanageur($com->Commercial)); ?>"><?php echo e($com->Commercial); ?></td>
									<td style="vertical-align:middle; text-align: center;">
										...
										<div class="btn-group">
											...
											<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: -80px; right: auto; transform: translate3d(0px, 38px, 0px);">
												...
												?>
												<?php if(in_array("other_com_sp", session("auto_action"))): ?>
												<span>
													<a class="dropdown-item autrecom" href="#autrCom" data-toggle="modal" data-id="<?php echo e($comptejson); ?>autr" title="">Autres Commissions</a>
												</span>
												<?php endif; ?>
												<?php if(in_array("bonus_com_sp", session("auto_action"))): ?>
												<span>
													<a class="dropdown-item autrecom" href="#autrCom" data-toggle="modal" data-id="<?php echo e($comptejsonbonus); ?>bonu" title="">Bonus</a>
												</span>
												<?php endif; ?>
												<br>
												<?php if(in_array("retenue_com_sp", session("auto_action"))): ?>
												<span>
													<a class="dropdown-item autrecom" href="#autrCom" data-toggle="modal" data-id="<?php echo e($comptejsonretenue); ?>rete" title="">Retenue</a>
												</span>
												<?php endif; ?>
												<br>
								...
								<tr>
									<td colspan="12"><center>Commission indisponible pour ce mois!!! </center></td>
								</tr>
								<?php endif; ?>
							</tbody>
						</table>
...
<?php $__env->startSection('js'); ?>
    <script type="text/javascript">
	        ...
	        $(".autrecom").click(function () {
	            ...
	            if(id.substr(-4, 4) == "autr"){
	            	...
	            	div.innerHTML = '<div class="modal-header">' +
						...
						'<form class="form-horizontal" method="post" action="<?php echo e(route("SAC")); ?>">' +
						'<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
				...
				if (id.substr(-4,4) == "bonu") {
                    ...
                    div.innerHTML = '<div class="modal-header">' +
                        ...
                        '</div><div class="modal-body">' +
                        '<form class="form-horizontal" method="post" action="<?php echo e(route("SBC")); ?>">' +
                        '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                        '<input type="hidden" name="codecom" value="'+json.com+'" /> ' +
                        '     <div class="form-group"> ' +
                        '<div class="col-sm-12"> ' +
				...
				if (id.substr(-4,4) == "rete") {
                    ...
                    div.innerHTML = '<div class="modal-header">' +
                        ...
                        '</div><div class="modal-body">' +
                        '<form class="form-horizontal" method="post" action="<?php echo e(route("SDC")); ?>">' +
                        '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                        '<input type="hidden" name="codecom" value="'+json.com+'" /> ' +
                        '     <div class="form-group"> ' +
                        '<div class="col-sm-12"> ' +
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '</div><div class="modal-body">' +
                    '<form class="form-horizontal" method="post" action="<?php echo e(route("SIAC")); ?>" enctype="multipart/form-data">' +
                    '<input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> '+
                    '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                    '<div class="form-group"> ' +
                    '<div class="col-sm-12">' +
                    '<a class="btn-primary" style="float:right; color: white; padding: 15px; margin-right: 10px" href="<?php echo e(route("IAC")); ?>"> Télécharger le fichier à remplir </a>' +
                    '</div> ' +
                    '</div> ' +
                    ' <div class="form-group"> ' +
                    '<div class="col-sm-12"> ' +
                ...
                if(id.substr(-4, 4) == "reje"){
                    ...
                    div.innerHTML = '<div class="modal-header">' +
                        ...
                        '</div><div class="modal-body">' +
                        '<form class="form-horizontal" method="post" action="<?php echo e(route("RCSP")); ?>">' +
                            '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
        ...
        function validecomm(){
            ...
            var comt = document.getElementById("comment").value;
            ...
            document.getElementById("infoconfirme").innerHTML = "En cours de traitement des commissions. Le processus peut prendre quelques minutes. Veuillez patienter jusqu'à la fin.";
                ...
                var xhr = getXMLHttpRequest(); 
                  xhr.open("GET", "<?php echo e(route('listCommConfirm')); ?>?comment="+comt, true);
                  xhr.send(null);
