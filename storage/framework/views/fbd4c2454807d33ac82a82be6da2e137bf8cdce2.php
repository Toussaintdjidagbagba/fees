	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
		...
		<div class="box-content bordered info js__card">
			...
			<h4 class="box-title with-control">
				<?php if($affcom->codeEquipe == ""): ?>
				    Adhéré une équipe NSIA :
				<?php else: ?>
            Modifier l'équipe NSIA :
				<?php endif; ?>
			<span class="controls">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="<?php echo e(route('SAdhC')); ?>" enctype="multipart/form-data"  >
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<label for="inp-type-1" style="vertical-align:middle; margin-top: 1%;" class="col-sm-12  ">Equipe actuelle : </label>
										<div class="col-sm-12">
						...
						<div class="col-sm-6">
								...
								<table id="myTable">
									...
									<?php $__empty_1 = true; $__currentLoopData = $allequipe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eqp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
										<tr>
									  	<td><input type= "radio" name="equipeselect" value="<?php echo e($eqp->codeH); ?>" required></td>
									    <td><?php echo e($eqp->codeH); ?></td>
									    <td><?php echo e(App\Providers\InterfaceServiceProvider::infosup($eqp->codeH)); ?></td>
									  </tr>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
									<tr>
										<td colspan="3"><center>Pas d'équipe disponible !! </center></td>
									</tr>
									<?php endif; ?>
