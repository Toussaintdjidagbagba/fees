		...
		<div class="box-content bordered info js__card">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="<?php echo e(route('ModifProd')); ?>" >
							...
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="hidden" name="id" value="<?php echo e($info->idProduit); ?>" />
