	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
		...
		<div class="box-content bordered info js__card">
			...
			<h4 class="box-title with-control">
				...
				Liste Commissions Groupe <?php echo e(utf8_encode(strtoupper(strftime('%B %Y')))); ?> NSIA ( <?php echo e($libelleRole); ?> ) : 
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					...
					<?php endif; ?>
					<!------------------------------------------>
					<!--form class="form-horizontal" action="<?php echo e(route('GCCDAF')); ?>" method="GET" id="recherche">
					...
					<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp->compteMoisGroupe + $comp->compteEncadrementMoisCalculerGroupe, 0, '.', ' ')); ?> CFA</td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp->aibCalculerGroupe, 0, '.', ' ')); ?> CFA</td>
										<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp->compteGroupe, 0, '.', ' ')); ?> CFA</td>
									<td style="vertical-align:middle; text-align: center;">
									    <form action="Gdetailcommission-groupe-<?php echo e($com->Commercial); ?>">
	    ...
	    $(function () {
            ...
            if(id.substr(-4, 4) == "reje"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '<form class="form-horizontal" method="post" action="<?php echo e(route("RCCDAFG")); ?>">' +
                        '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
            ...
            if(id.substr(-4, 4) == "conf"){
                ...
                div.innerHTML = '<div class="modal-header">' +
					...
					'<a href="<?php echo e(route("ConfirmCDAFG")); ?>">' +
