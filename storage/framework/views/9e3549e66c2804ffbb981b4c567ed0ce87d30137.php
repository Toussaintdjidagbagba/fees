		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">  
					...
					<form class="form-horizontal" action="<?php echo e(route('histCommissionPDF')); ?>" method="post" id="recherche">
						...
						<div class="form-group">
							<div class="col-sm-3" style="margin-left: 20px;">
								...
								<input class="form-control" type="month" name="mois" value="" min="2021-12" max="<?php echo e(date('Y-m', strtotime('0 month'))); ?>">
							...
							<?php if(in_array("export_pdf_com_global", session("auto_action"))): ?>
						...
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped" style="font-size: 10px;">
							...
							<tbody id="data">
								...
								<tr>
									...
									<!--th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e(number_format(($comp['bonus'] + $comp['fixe'] + 
									...
									<?php if($net_temp != 0): ?>
    									<?php if(round(($comp['aibMoisCalculer'] / $net_temp) * 100) == 5): ?>
    									    <td style="vertical-align:middle; text-align: center;"></td>
    									<?php else: ?>
    									    <td style="vertical-align:middle; text-align: center;"><?php echo e(App\Providers\InterfaceServiceProvider::recipIFU($com->Commercial)); ?></td>
    									<?php endif; ?>
									<?php else: ?>
									    <td style="vertical-align:middle; text-align: center;"></td>
									<?php endif; ?>
									...
									<?php else: ?>
									    <th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e(round(($comp['aibMoisCalculer'] / $net_temp) * 100)); ?> %</th>
									<?php endif; ?>
									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp['aibMoisCalculer'] , 0, '.', ' ')." CFA"); ?></th>
									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp['recentrembourcer'] , 0, '.', ' ')." CFA"); ?></th>
									
									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp['retenue'] , 0, '.', ' ')." CFA"); ?></th-->
									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp['compte'], 0, '.', ' ')." CFA"); ?></th>
									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e($com->moiscalculer); ?></th>
									
								    <td style="vertical-align:middle; text-align: center;">
								        <form action="histcommission-<?php echo e($com->id); ?>">
