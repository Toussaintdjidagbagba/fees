		...
		<div class="box-content bordered info js__card"> 
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					<div id="ref">
						Ref <b style="color:#001e60">SP <img src="<?php echo e($signaturesp); ?>" id="signataire"></b>/<b style="color:#001e60">CSP</b>/<?php echo e($sigle); ?>

					</div> 
					<?php if(in_array("confirm_csp_com", session("auto_action"))): ?>
					...
					<?php endif; ?> 
					<a class="btn-primary dropdown-item" style="float: right; margin-right: 10px" href="<?php echo e(route('GEDREXCEL')); ?>">Exportation en excel </a>
					<!--a class="btn-primary dropdown-item" style="float: right; margin-right: 10px" href="<?php echo e(route('GEDREXCEL')); ?>">Etat détail </a-->
					<!------------------------------------------>
					<!--form class="form-horizontal" action="<?php echo e(route('GCCSP')); ?>" method="GET" id="recherche">
					...
					<div class="table-responsive" data-pattern="priority-columns">
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tr>
								...
								<th data-priority="1" style="vertical-align:middle;text-align: center;"> <?php echo e(number_format($aib, 0, '.', ' ')); ?> CFA </th>

								<th data-priority="1" style="vertical-align:middle;text-align: center;"> <?php echo e(number_format($retenue, 0, '.', ' ')); ?> CFA </th>

								<th data-priority="1" style="vertical-align:middle;text-align: center;"> <?php echo e(number_format($naf, 0, '.', ' ')); ?> CFA </th>
								...
								<th data-priority="1" style="vertical-align:middle;text-align: center;"> <?php echo e(number_format($bloque, 0, '.', ' ')); ?> CFA</th>
							...
							<tbody>
								...
								<tr>
									...
									<?php 
										$combrute = $comp->compteMoisCalculer + $comp->compteEncadrementMoisCalculer + $comp->AutreCommissionMoisCalculer + $comp->bonus + $comp->fixe + $comp->compteBloquerBackup;
									?>
									<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($combrute, 0, '.', ' ')); ?> CFA</td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp->aibMoisCalculer, 0, '.', ' ')); ?> CFA</td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp->retenue, 0, '.', ' ')); ?> CFA</td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp->tracenaf, 0, '.', ' ')); ?> CFA</td>
									...
									<td style="vertical-align:middle; text-align: center;"><?php echo e(number_format($comp->compteBloquer, 0, '.', ' ')); ?> CFA</td>
	    ...
	    $(function () {
            ...
            if(id.substr(-4, 4) == "conf"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '<a href="<?php echo e(route("ConfirmCSP")); ?>">' +
            ...
            if(id.substr(-4, 4) == "reje"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '</div><div class="modal-body">' +
                    '<form class="form-horizontal" method="post" action="<?php echo e(route("RCCSP")); ?>">' +
                        '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
