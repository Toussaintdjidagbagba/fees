	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
		...
		<div class="box-content bordered info js__card">
			...
			<h4 class="box-title with-control">
			 Historique des Commissions de  <?php echo e($nomapp); ?> ( <?php echo e($mois); ?> ) : 
			<span class="controls">
				        ...
				        <div class="box-content" >
							...
							<div class="form-group">
								<div class="col-sm-3">
									...
									<div class="col-sm-12">
									    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e($comp['Agent']); ?>"> </div>
							    </div>
								<div class="col-sm-3">
							    ...
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e($comp['libCompte']); ?>"> </div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e($comp['numCompte']); ?>"> </div>
							    </div>
							</div> 
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['tauxCarec'] , 0, '.', ' ')." %"); ?>"></div>
							    </div>
							    <div class="col-sm-6">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['montantAmical'] , 0, '.', ' ')); ?>  CFA"></div>
							    </div>
							</div>
							...
							<div class="form-group">
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['compteMoisCalculer']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['compteEncadrementMoisCalculer']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['AutreCommissionMoisCalculer']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['bonus']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
							...
							<div class="form-group">
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['fixe']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['compteBloquer']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['dotationTelephonie']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format(($comp['dotationCarburant']), 0, '.', ' ')." CFA"); ?>"> </div>
							    </div>
							...
							<div class="form-group">
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['avancesancien'] , 0, '.', ' ')); ?>  CFA"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['recentrembourcer'] , 0, '.', ' ')); ?>  CFA"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['anticiper'] , 0, '.', ' ')); ?>"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['duree'] , 0, '.', ' ')); ?>"></div>
							    </div>
							</div>
							<div class="form-group">
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['aibMoisCalculer'], 0, '.', ' ')); ?> CFA"></div>
							    </div>
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['retenue'] , 0, '.', ' ')); ?> CFA"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['traceCarec'] , 0, '.', ' ')); ?>  CFA"></div>
							    </div>
								<div class="col-sm-3">
								    <label for="inp-type-1" style="vertical-align:middle; margin-top: 1%; font-size: 14px; font-weight: bold;" class="col-sm-12">Montant Amical : </label>
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['tracesAmical'] , 0, '.', ' ')); ?>  CFA"></div>
							    </div>
							...
							<div class="form-group">
							    <div class="col-sm-12">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="<?php echo e(number_format( $comp['compte'] , 0, '.', ' ')." CFA"); ?>"></div>
							    </div>
					...
					<div class="table-responsive" data-pattern="priority-columns">
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped" style="font-size: 10px;">
							...
							<tbody id="data">
								...
								<tr>
							        <th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e($com->NumPolice); ?></th>
									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e($com->Client); ?></th>
									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e($com->NumQuittance); ?></th>
								...
								<?php if($niveau <> "CONS"): ?>
    							    ...
    							    <tr>
    								    <th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e($comm->NumPolice); ?></th>
    									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e($comm->Client); ?></th>
    									<th data-priority="1" style="vertical-align:middle; text-align: center;"><?php echo e($comm->NumQuittance); ?></th>
