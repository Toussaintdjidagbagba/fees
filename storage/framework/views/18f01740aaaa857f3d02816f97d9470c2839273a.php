...
<?php if(in_array("add_coordination", session("auto_action"))): ?>
			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="<?php echo e(route('addCd')); ?>"  enctype="multipart/form-data" >
             ...
             <input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> <!-- Limite 5Mo -->
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-6">
								<label for="inp-type-2" style="vertical-align:middle;" class="col-sm-12 ">Chef Coordination :</label>
								<div class="col-sm-12">
					...
					<script>		
						...
						y.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "<?php echo e(route('listCd')); ?>?check="+search+"&rec=1", true);
							xhr.send(null);
						...
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							<thead>
								<tr>
									...
									<th class="textcenter" data-priority="1">Chef coordination</th>
							...
							<tbody id="data">
								...
								<?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
								<tr>
									<th style="text-align: center; vertical-align:middle;">
										<span class="co-name"><?php echo e($cd->codeH); ?></span>
									</th>
									<td style="text-align: center; vertical-align:middle;">
										Coordination
									</td>
									<td style="text-align: center; vertical-align:middle;">
										<?php echo e($cd->libelleH); ?>

									</td>
									<td style="text-align: center; vertical-align:middle;"  
										title="<?php echo e(App\Providers\InterfaceServiceProvider::infomanageur($cd->managerH)); ?>">
									    <?php echo e($cd->managerH); ?>

								    </td>
									
									<td style="text-align: center; vertical-align:middle;"><?php echo e($cd->villeH); ?></td>
									<td style="text-align: center; vertical-align:middle;"><?php echo e(App\Providers\InterfaceServiceProvider::LibelleUser($cd->user_action)); ?></td>
									<td style="text-align: center; vertical-align:middle;">
										<?php if(in_array("update_coordination", session("auto_action"))): ?>
									<button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="/modif-cd-<?php echo e($cd->codeH); ?>" style="color:white;"><i class="ico fa fa-edit"></i> </a>
									</button>
									<?php endif; ?>
								...
								<tr>
									<td colspan="8"><center>Pas de coordination enregistrer!!! </center></td>
								</tr>
								<?php endif; ?>
							</tbody>
						</table>
