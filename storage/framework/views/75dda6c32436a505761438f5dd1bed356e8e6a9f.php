			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
                    <form class="form-horizontal" method="post" action="<?php echo e(route('GRTS')); ?>" id="vue">
                        ...
                        <div class="form-group">
								<div class="col-sm-5">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1" value="<?php echo e(session('qr')); ?>" name="qr" id="qr" required>
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="inp-type-2" value="<?php echo e(session('montall')); ?>" name="mont" readonly>
								</div>
								<div class="col-sm-2">
			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="<?php echo e(route('SRT')); ?>">
							<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
							<input type="hidden" value="<?php echo e(session('qr')); ?>" name="qr">
					...
					<div class="table-responsive" data-pattern="priority-columns">
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody>
								...
								<?php if(session('allreglement') != ""): ?>
									<?php $__currentLoopData = session('allreglement'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reglement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
									...
									<th data-priority="6"><center>
										<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="/delete-reglement-<?php echo e($reglement->idReglement); ?>" style="color:white;"><i class="ico fa fa-trash"></i></a> </button>
									</center></th>
								</tr>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
	    ...
	    function getXMLHttpRequest() {
            ...
            function validecomm(){
                ...
                var xhr = getXMLHttpRequest(); 
                  xhr.open("GET", "<?php echo e(route('SCTV')); ?>", true);
                  xhr.send(null);
