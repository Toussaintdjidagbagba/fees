		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					<div id="ref">
						Ref <b style="color:#001e60">SP <img src="<?php echo e($signaturesp); ?>" id="signataire"></b>/<b style="color:#001e60">CSP <img src="<?php echo e($signaturecsp); ?>" id="signataire"> </b>/<b style="color:#001e60">DT  <img src="<?php echo e($signaturedt); ?>" id="signataire"> </b>/ <b style="color:#001e60">DG</b>/<?php echo e($sigle); ?>

					</div>
					<?php if(in_array("confirm_dg_com", session("auto_action"))): ?>
					...
					<?php endif; ?>
					<!------------------------------------------>
					<!--form class="form-horizontal" action="<?php echo e(route('GCDG')); ?>" method="GET" id="recherche">
	    ...
	    $(function () {
            ...
            if(id.substr(-4, 4) == "reje"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '<form class="form-horizontal" method="post" action="<?php echo e(route("RCDG")); ?>">' +
                        '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
            ...
            if(id.substr(-4, 4) == "conf"){
                ...
                div.innerHTML = '<div class="modal-header">' +
					...
					'<a href="<?php echo e(route("ConfirmDG")); ?>">' +
