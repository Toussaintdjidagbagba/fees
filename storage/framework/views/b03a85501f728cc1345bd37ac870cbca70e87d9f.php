		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
				    <?php if(in_array("export_recl", session("auto_action"))): ?> 
                                ...
                                if(response.status == 200)
                                {
                                    ...
                                    if(suc == true){
                                      list.forEach(function(recl){
        									...
        									html += '<td style="vertical-align:middle; text-align: center;"><?php echo e(App\Providers\InterfaceServiceProvider::RecupInfoClient('+recl.client+')); ?></td>';
					...
					<div class="table-responsive" data-pattern="priority-columns">
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody id="data">
								...
								<tr>
									<td style="vertical-align:middle; text-align: center;"><?php echo e(App\Providers\InterfaceServiceProvider::Libellecom($com->apporteur)); ?>(<?php echo e($com->apporteur); ?>)</td>
									...
									<td style="vertical-align:middle; text-align: center;"><?php echo e(App\Providers\InterfaceServiceProvider::RecupInfoClient($com->client)); ?></td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e($com->typerecl); ?></td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e($com->librecl); ?></td> 
									<td style="vertical-align:middle; text-align: center;">
									    <?php if($com->etatnsia == 0): ?> Non traité <?php else: ?> traité <?php endif; ?>
									</td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e($com->created_at); ?></td>
									<td style="vertical-align:middle; text-align: center;">
									<a href="<?php echo e(route('GetModifRecl', $com->id)); ?>" style="color:white;">
									...
									<button type="button" title="Supprimer" onclick="avissuppr(<?php echo e($com->id); ?>, '<?php echo e($com->typerecl); ?>', '<?php echo e($com->librecl); ?>', '<?php echo e(App\Providers\InterfaceServiceProvider::Libellecom($com->apporteur)); ?>')" data-toggle="modal" data-target="#add" class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"> 
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content" id="tst">
			...
			<div class="modal-body">
			    <form class="form-horizontal" method="get" action="<?php echo e(route('DelRecl')); ?>">
