	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
		...
		<div class="box-content bordered info js__card">
			...
			<h4 class="box-title with-control">
				<?php if($type == "CEQP"): ?>
				    Modifier une inspection existante NSIA :
				<?php endif; ?>
				<?php if($type == "CONS"): ?>
            Modifier une équipe existante NSIA :
				<?php endif; ?>
				<?php if($type == "INS" || $type == "BD" || $type == "BDS" || $type == "APL"): ?>
            Modifier une région existante NSIA :
				<?php endif; ?>
			<span class="controls">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="<?php echo e(route('GES')); ?>" enctype="multipart/form-data" >
							...
							<div class="col-sm-6">
								...
								<div class="form-group" style="display: block;" >
										<div class="col-sm-12">
											<?php if($type == "CEQP"): ?>
															<button type="submit" class="btn btn-primary btn-sm waves-effect waves-light" style="float:left; margin-top: 20px; margin-left: 15px; width: 50%;">Mettre à jour l'inspection
															</button>
											<?php endif; ?>
											<?php if($type == 'CONS'): ?>
															<button type="submit" class="btn btn-primary btn-sm waves-effect waves-light" style="float:left; margin-top: 20px; margin-left: 15px; width: 50%;">Mettre à jour l'équipe
															</button>
											<?php endif; ?>
											<?php if($type == "INS" || $type == "BD" || $type == "BDS" || $type == "APL"): ?>
															<button type="submit" class="btn btn-primary btn-sm waves-effect waves-light" style="float:left; margin-top: 20px; margin-left: 15px; width: 50%;">Mettre à jour la région
															</button>
											<?php endif; ?>
										</div>
								</div>
						...
						<div class="col-sm-6">
							...
							<?php endif; ?>
							<?php if($type == "INS" || $type == "BD" || $type == "BDS" || $type == "APL"): ?>
								<input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Recherche par code région"> 
							<?php endif; ?>
								...
								<table id="myTable">
									<tr>
										<th></th>
										<th>
											<?php if($type == "CEQP"): ?> Code Inspection <?php endif; ?>
											<?php if($type == 'CONS'): ?> Code Equipe <?php endif; ?>
											<?php if($type == "INS" || $type == "BD" || $type == "BDS" || $type == "APL"): ?> Code Région <?php endif; ?>
										</th>
										<th>
											<?php if($type == "CEQP"): ?> Nom Chef Inspection <?php endif; ?>
											<?php if($type == 'CONS'): ?> Nom Chef Equipe <?php endif; ?>
											<?php if($type == "INS" || $type == "BD" || $type == "BDS" || $type == "APL"): ?> Nom Chef Région <?php endif; ?>
										</th>
									</tr>
									<?php $__empty_1 = true; $__currentLoopData = $all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eqp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
										<tr>
									  	<td><input type= "radio" name="insselect" value="<?php echo e($eqp->codeH); ?>" required></td>
									    <td><?php echo e($eqp->codeH); ?></td>
									    <td><?php echo e(App\Providers\InterfaceServiceProvider::infosup($eqp->codeH)); ?></td>
									  </tr>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
									<tr>
										<td colspan="3"><center>Pas d'infos disponible !! </center></td>
									</tr>
									<?php endif; ?>
