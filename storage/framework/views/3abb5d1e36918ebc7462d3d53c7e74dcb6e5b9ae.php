...
<?php $__env->startSection('content'); ?>
    ...
    <div  class="col-lg-3 col-md-4 col-xs-6"> 
       <?php if(in_array("export_commerciaux", session("auto_action"))): ?>
            <a class="btn btn-info btn-rounded btn-bordered waves-effect waves-light dropdown-item" style="margin-bottom:5px; min-width: 200px; padding: 8px;"
            					href="<?php echo e(route('ECAT')); ?>" title="Exporter les commerciaux">EXPORTER <i class="fa fa-file-excel-o" aria-hidden="true"></i> </a>
        <?php endif; ?>
    </div>
    <div  class="col-lg-3 col-md-4 col-xs-6"> 
    ...
    <div  class="col-lg-3 col-md-4 col-xs-6"> 
        <?php if(in_array("carec_commerciaux", session("auto_action"))): ?>
    ...
    <div  class="col-lg-3 col-md-4 col-xs-6"> 
        <?php if(in_array("amical_commerciaux", session("auto_action"))): ?>
    ...
    <div  class="col-lg-3 col-md-4 col-xs-6"> 
       <?php if(in_array("export_commerciaux", session("auto_action"))): ?>
            <a class="btn btn-info btn-rounded btn-bordered waves-effect waves-light dropdown-item" style="margin-bottom:5px; min-width: 200px; padding: 8px;"
            					href="<?php echo e(route('EAVNV')); ?>" title="">AVANCE REMBOURSER <i class="fa fa-file-excel-o" aria-hidden="true"></i> </a>
        <?php endif; ?>
    ...
    <div  class="col-lg-3 col-md-4 col-xs-6"> 
       <?php if(in_array("export_commerciaux", session("auto_action"))): ?>
            <a class="btn btn-info btn-rounded btn-bordered waves-effect waves-light dropdown-item" style="margin-bottom:5px; min-width: 200px; padding: 8px;"
            					href="<?php echo e(route('EAVNVD')); ?>" title="">AVANCE DUES <i class="fa fa-file-excel-o" aria-hidden="true"></i> </a>
        <?php endif; ?>
        
    </div>
    <div  class="col-lg-3 col-md-4 col-xs-6"> 
       <?php if(in_array("add_agence", session("auto_action"))): ?>
		    <a class="btn btn-info btn-rounded btn-bordered waves-effect waves-light dropdown-item identifyingeqp" style="margin-bottom:5px; min-width: 200px;  padding: 8px;" href="#add" 
    ...
    <div class="col-lg-12 col-md-12 col-xs-12"> 
		<div class="box-content bordered info js__card">
			...
			<?php if(App\Providers\InterfaceServiceProvider::nivprocessus() == 1): ?>
			<div class="js__card_content">
				...
				<div class="row small-spacing">  
					...
					<!------------------------------------------>
					<form class="form-horizontal" action="<?php echo e(route('listC')); ?>" method="GET" id="recherche">
					...
					<div class="table-responsive" data-pattern="priority-columns">
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody id="data">
								...
								<tr>
									<td style="vertical-align:middle; text-align: center;"><?php echo e($com->codeCom); ?></td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e($com->nomCom); ?> <?php echo e($com->prenomCom); ?></td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e($com->mail); ?></td>
									<td style="vertical-align:middle; text-align: center;"><?php echo e(App\Providers\InterfaceServiceProvider::infoniveau($com->Niveau)->libelleNiveau); ?></td>
									<td style="vertical-align:middle; text-align: center;" title="Chef Equipe : <?php echo e(App\Providers\InterfaceServiceProvider::infohier($com->codeEquipe)); ?>" ><?php echo e($com->codeEquipe); ?></td>
									<td style="vertical-align:middle; text-align: center;" title="Chef Inspecteur : <?php echo e(App\Providers\InterfaceServiceProvider::infohier($com->codeInspection)); ?>"><?php echo e($com->codeInspection); ?></td>
									<td style="vertical-align:middle; text-align: center;" title="Chef Région : <?php echo e(App\Providers\InterfaceServiceProvider::infohier($com->codeRegion)); ?>"><?php echo e($com->codeRegion); ?></td>
									<td style="vertical-align:middle; text-align: center;" title="Chef Coordination : <?php echo e(App\Providers\InterfaceServiceProvider::infohier($com->codeCD)); ?>"><?php echo e($com->codeCD); ?></td>
									<td style="vertical-align:middle; text-align: center;">
										...
										<div class="btn-group">
											...
											<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: -200px; right: auto; transform: translate3d(0px, 38px, 0px);">
												<span>
														<a class="dropdown-item" href="/adhère-coordination-<?php echo e($com->codeCom); ?>" title="Adhérer une équipe">Adhérer une coordination</a>
													</span>
												<?php if(in_array("update_commercial", session("auto_action"))): ?> 
												<span>
													<a class="dropdown-item" href="/modif-commerciaux-<?php echo e($com->codeCom); ?>" title="Modifier">Modifier le commercial</a>
												</span>
												<?php endif; ?>
												<?php 
												...
												?>
												<?php if(in_array("show_account_commercial", session("auto_action"))): ?> 

												<span>
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejson); ?>comp" title="Compte">Compte du commercial</a>
												</span>

												<?php endif; ?>

												<?php if(in_array("advance_commercial", session("auto_action"))): ?> 
												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejson); ?>avan" title="Avance">Imputer une avance</a>
												</span><br>
												<?php endif; ?>
												
												<?php if(in_array("advance_commercial", session("auto_action"))): ?> 
												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejson); ?>anav" title="Annulation une avance">Annulation une avance</a>
												</span><br>
												<?php endif; ?>
												
												<?php if(in_array("other_com_hie", session("auto_action"))): ?>
												<span>
													<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejsonothercom); ?>autr" title="">Autres Commissions</a>
												</span><br>
												<?php endif; ?>
												
												<?php if(in_array("bonus_com_hie", session("auto_action"))): ?>
												<span>
													<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejsonbonus); ?>bonu" title="">Bonus</a>
												</span>
												<?php endif; ?>
												<br>
												<?php if(in_array("retenue_com_hie", session("auto_action"))): ?>
												<span>
													<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejsonretenue); ?>rete" title="">Retenue</a>
												</span> <br>
												<?php endif; ?>
												
												<?php if(in_array("anticipation_reimbursement", session("auto_action"))): ?>
												<span>
													<a class="dropdown-item identifyingeqp" href="#add" data-toggle="modal" data-id="<?php echo e($comptejsonavance); ?>remb" title="">Remboursement anticiper</a> <br>
												</span>
												<?php endif; ?>
												
												<?php if(in_array("actv_commercial", session("auto_action"))): ?> 
                                                
												<span>	
												<?php if($com->statut == '0'): ?>
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($compteactivjson); ?>actv" title="Désactiver">Désactiver ?</a>
												<?php endif; ?>
												<?php if($com->statut == '1'): ?>
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($compteactivjson); ?>actv" title="Activer">Activer ?</a>
												<?php endif; ?>
												</span><br>
												<?php endif; ?>

												<?php if(in_array("fixe_commercial", session("auto_action"))): ?> 

												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejson); ?>fixe" title="Fixe">Fixe</a>
												</span><br>
												<?php endif; ?>
												
												<?php if(in_array("carec_commercial", session("auto_action"))): ?> 
												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptecarerjson); ?>care" title="Carec">Carec</a>
												</span><br>
												<?php endif; ?>
												
												<?php if(in_array("ami_commercial", session("auto_action"))): ?> 
												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($compteamijson); ?>acim" title="Amical">Amical</a>
												</span><br>
												<?php endif; ?>
												
												<?php if(in_array("ami_commercial", session("auto_action"))): ?> 
												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptenafjon); ?>nafp" title="Naf">NAF</a>
												</span><br>
												<?php endif; ?>
												
												<?php if(in_array("add_telephone_staffing_commercial", session("auto_action"))): ?> 
												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejson); ?>tele" title="Téléphonie">Dotation Téléphonie</a>
												</span><br>
												<?php endif; ?>

												<?php if(in_array("add_fuel_staffing_commercial", session("auto_action"))): ?> 

												<span>	
												<a class="dropdown-item identifyingeqp" href="#add" data-target="#add" data-toggle="modal" data-id="<?php echo e($comptejson); ?>carb" title="Carburant">Dotation Carburant</a>
												</span><br>
												<?php endif; ?>

												<?php if($com->Niveau == "CONS" || $com->Niveau == "AG" || $com->Niveau == "INST" || $com->Niveau == "B" || $com->Niveau == "COU"): ?>
													<?php if($com->codeEquipe == ""): ?>
													<?php if(in_array("Join_team_commercial", session("auto_action"))): ?> 
													<span>
														<a class="dropdown-item" href="/adhère-equipe-<?php echo e($com->codeCom); ?>" title="Adhérer une équipe">Adhérer une équipe</a>
													</span>
													<?php endif; ?>

													<?php else: ?>
													<?php if(in_array("update_equipe_commercial", session("auto_action"))): ?> 
													<span>
														<a class="dropdown-item" href="/changer-equipe-<?php echo e($com->codeCom); ?>" title="Changer d'équipe">Changer d'équipe</a>
													</span>
													<?php endif; ?>
													<?php endif; ?>
													<?php if(in_array("leader_equipe_commercial", session("auto_action"))): ?> 
													<span>
														<a class="dropdown-item" href="/addmanageurequipe-<?php echo e($com->codeCom); ?>"  title="Devenir chef d'équipe (NOUVELLE)">Devenir chef d'Equipe</a>
													</span>
													<?php endif; ?>

													<?php if(in_array("leader_equipe_existante_commercial", session("auto_action"))): ?> 
													<span>
														<a class="dropdown-item" href="/addexistanteqp-<?php echo e($com->codeCom); ?>"  title="Devenir chef d'équipe (EXISTANTE)">Devenir chef d'Equipe (EXISTANTE)</a>
													</span>
													<?php endif; ?>
												<?php else: ?>
												    <?php if($com->Niveau == "CEQP"): ?>
												    <?php if(in_array("Inspection_head_commercial", session("auto_action"))): ?> 
													<span> 
														<a class="dropdown-item" href="/addmanageurins-<?php echo e($com->codeCom); ?>"  title="Devenir chef d'une inspection (NOUVELLE)">Devenir chef d'Inspection</a>
													</span>
													<?php endif; ?>
													<?php if(in_array("Inspection_head_existante_commercial", session("auto_action"))): ?> 
													<span>
														<a class="dropdown-item" href="/addexistantins-<?php echo e($com->codeCom); ?>"  title="Devenir chef d'une inspection (EXISTANTE)">Devenir chef d'une Inspection (EXISTANTE)</a>
													</span>
													<?php endif; ?>

													<?php if(in_array("downgrade_cons_commercial", session("auto_action"))): ?> 
													<span>
														<a class="dropdown-item" href="/retrograder-<?php echo e($com->codeCom); ?>" title="Rétrograder le commercial en CONSEILLER">Rétrograder</a>
												    </span>
												    <?php endif; ?>

													<?php else: ?>
													     <?php if($com->Niveau == "INS" || $com->Niveau == "BD" || $com->Niveau == "BDS" || $com->Niveau == "APL"): ?>
													     <?php if(in_array("leader_region_commercial", session("auto_action"))): ?> 
													        <span>
															<a class="dropdown-item" href="/addmanageurrg-<?php echo e($com->codeCom); ?>" title="Devenir chef d'une région (NOUVEAU)">Devenir chef d'une région</a> 
															</span>
															<?php endif; ?>

															<?php if(in_array("leader_region_existante_commercial", session("auto_action"))): ?> 
															<span>
																<a class="dropdown-item" href="/addexistantrg-<?php echo e($com->codeCom); ?>" data-toggle="modal" title="Devenir chef d'une région (EXISTANTE)">Devenir chef d'une région (EXISTANTE)</a>
															</span>
															<?php endif; ?>

															<?php if(in_array("downgrade_ceqp_commercial", session("auto_action"))): ?> 

															<span>
																<a class="dropdown-item" href="/retrograder-<?php echo e($com->codeCom); ?>" title="Rétrograder le commercial en CHEF D'EQUIPE ">Rétrograder</a>
														    </span>
														    <?php endif; ?>

													     <?php else: ?>
														     <?php if(in_array("downgrade_ins_commercial", session("auto_action"))): ?> 
															<span>
																<a class="dropdown-item" href="/retrograder-<?php echo e($com->codeCom); ?>" title="Rétrograder le commercial en INSPECTION ">Rétrograder</a>
															</span>
															<?php endif; ?>
	            ...
	            if (id != 0) {
	                ...
	                if(id.substr(-4, 4) == "anav"){
	            	    ...
	            	    var json = JSON.parse(identifiant);
                            ...
                            div.innerHTML = '' +
                                ...
                                '   <form class="form-horizontal" method="post" action="<?php echo e(route("SICA")); ?>">' +
                                '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                	...
                	if(id.substr(-4, 4) == "avan"){
	            	    ...
	            	    if(json.avance == 0)
                			div.innerHTML = '' +
	                            ...
	                            '</div>' +
	                            '<div class="modal-body">' +
	                            '   <form class="form-horizontal" method="post" action="<?php echo e(route("SIC")); ?>">' +
	                            '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	                            '      <input type="hidden" name="codeagent" value="'+json.Agent+'" />' +
                	...
                	if(id.substr(-4, 4) == "autr"){
    	            	...
    	            	div.innerHTML = '<div class="modal-header">' +
    						...
    						'</div><div class="modal-body">' +
    						'<form class="form-horizontal" method="post" action="<?php echo e(route("SACC")); ?>">' +
    						'<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                	...
                	if (id.substr(-4,4) == "bonu") {
                        ...
                        div.innerHTML = '<div class="modal-header">' +
                            ...
                            '</div><div class="modal-body">' +
                            '<form class="form-horizontal" method="post" action="<?php echo e(route("SBCC")); ?>">' +
                            '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                            '<input type="hidden" name="codecom" value="'+json.Agent+'" /> ' +
                            '     <div class="form-group"> ' +
                            '<div class="col-sm-12"> ' +
                    ...
                    div.innerHTML = '<div class="modal-header">' +
                        ...
                        '</div><div class="modal-body">' +
                        '<form class="form-horizontal" method="post" action="<?php echo e(route("SDCC")); ?>">' +
                        '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                        '<input type="hidden" name="codecom" value="'+json.Agent+'" /> ' +
                        '     <div class="form-group"> ' +
                        '<div class="col-sm-12"> ' +
                	...
                	if(id.substr(-4, 4) == "remb"){
                        ...
                        div.innerHTML = '<div class="modal-header">' +
                            ...
                            '</div><div class="modal-body">' +
                            '<form class="form-horizontal" method="post" action="<?php echo e(route("SRAC")); ?>">' +
                                '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
                	...
                	if(id.substr(-4, 4) == "fixe"){
	            	    ...
	            	    var json = JSON.parse(identifiant);
                			div.innerHTML = '' +
	                            ...
	                            '</div>' +
	                            '<div class="modal-body">' +
	                            '   <form class="form-horizontal" method="post" action="<?php echo e(route("SICF")); ?>">' +
	                            '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	                            '      <input type="hidden" name="codeagent" value="'+json.Agent+'" />' +
	                            '      <div class="form-group">  ' +
	                ...
	                if(id.substr(-4, 4) == "care"){
	            	    ...
	            	    var json = JSON.parse(identifiant);
                			div.innerHTML = '' +
	                            ...
	                            '</div>' +
	                            '<div class="modal-body">' +
	                            '   <form class="form-horizontal" method="post" action="<?php echo e(route("SPC")); ?>">' +
	                            '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	                            '      <input type="hidden" name="codeagent" value="'+json.Agent+'" />' +
	                            '      <div class="form-group">  ' +
	                ...
	                if(id.substr(-4, 4) == "naff"){
                		div.innerHTML = '<div class="modal-header">' +
						                    ...
						                    '</div><div class="modal-body">' +
						                    '<form class="form-horizontal" method="post" action="<?php echo e(route("SENAF")); ?>" enctype="multipart/form-data">' +
						                    '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
						                    '<input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> '+
						                    '<div class="form-group"> ' +
						                    '<div class="col-sm-12">' +
						                    '<a class="btn-primary" style="float:right; color: white; padding: 15px; margin-right: 10px" href="<?php echo e(route("ENAF")); ?>"> Télécharger le fichier à remplir </a>' +
						                    '</div> ' +
						                    '</div> ' +
						                    ' <div class="form-group"> ' +
						                    '<div class="col-sm-12"> ' +
	                ...
	                if(id.substr(-4, 4) == "nafp"){
	            	    ...
	            	    var json = JSON.parse(identifiant);
                			div.innerHTML = '' +
	                            ...
	                            '</div>' +
	                            '<div class="modal-body">' +
	                            '   <form class="form-horizontal" method="post" action="<?php echo e(route("SPENAF")); ?>">' +
	                            '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	                            '      <input type="hidden" name="codeagent" value="'+json.Agent+'" />' +
	                            '      <div class="form-group">  ' +
	                            '           <label for="sc" class="col-sm-12 ">Compte actuel :</label>' +
	                ...
	                if(id.substr(-4, 4) == "tele"){
	            	    ...
	            	    var json = JSON.parse(identifiant);
                			div.innerHTML = '' +
	                            ...
	                            '</div>' +
	                            '<div class="modal-body">' +
	                            '   <form class="form-horizontal" method="post" action="<?php echo e(route("SICDT")); ?>">' +
	                            '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	                            '      <input type="hidden" name="codeagent" value="'+json.Agent+'" />' +
	                            '      <div class="form-group">  ' +
	                ...
	                if(id.substr(-4, 4) == "carb"){
	            	    ...
	            	    var json = JSON.parse(identifiant);
                			div.innerHTML = '' +
	                            ...
	                            '</div>' +
	                            '<div class="modal-body">' +
	                            '   <form class="form-horizontal" method="post" action="<?php echo e(route("SICDC")); ?>">' +
	                            '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	                            '      <input type="hidden" name="codeagent" value="'+json.Agent+'" />' +
	                            '      <div class="form-group">  ' +
                	...
                	if(id.substr(-4, 4) == "impo"){
						div.innerHTML = '<div class="modal-header">' +
						                    ...
						                    '</div><div class="modal-body">' +
						                    '<form class="form-horizontal" method="post" action="<?php echo e(route("IC")); ?>" enctype="multipart/form-data">' +
						                    '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
						                    '<input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> '+
						                    '<div class="form-group"> ' +
						                    '<div class="col-sm-12">' +
						                    '<a class="btn-primary" style="float:right; color: white; padding: 15px; margin-right: 10px" href="<?php echo e(url($exemple)); ?>"> Télécharger l\'exemplaire du fichier </a>' +
						                    '</div> ' +
						                    '</div> ' +
						                    ' <div class="form-group"> ' +
						                    '<div class="col-sm-12"> ' +
	            	...
	            	if(id.substr(-4, 4) == "agen"){
						div.innerHTML = '<div class="modal-header">' +
						                    ...
						                    '</div><div class="modal-body">' +
						                    '<form class="form-horizontal" method="post" action="<?php echo e(route("AddC")); ?>" >' +
						                    '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	            	...
	            	if(id.substr(-4, 4) == "cace"){
						div.innerHTML = '<div class="modal-header">' +
						                    ...
						                    '<h4 class="modal-title" id="myModalLabel">CAREC : </h4>' +
						                    '</div><div class="modal-body">' +
						                    '<form class="form-horizontal" method="post" action="<?php echo e(route("SECCC")); ?>" enctype="multipart/form-data">' +
						                    '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
						                    '<input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> '+
						                    '<div class="form-group"> ' +
						                    '<div class="col-sm-12">' +
						                    '<a class="btn-primary" style="float:right; color: white; padding: 15px; margin-right: 10px" href="<?php echo e(route("ECCC")); ?>"> Télécharger le fichier à remplir </a>' +
						                    '</div> ' +
						                    '</div> ' +
						                    ' <div class="form-group"> ' +
						                    '<div class="col-sm-12"> ' +
	            	...
	            	if(id.substr(-4, 4) == "amic"){
						div.innerHTML = '<div class="modal-header">' +
						                    ...
						                    '<h4 class="modal-title" id="myModalLabel">AMICAL : </h4>' +
						                    '</div><div class="modal-body">' +
						                    '<form class="form-horizontal" method="post" action="<?php echo e(route("SEAC")); ?>" enctype="multipart/form-data">' +
						                    '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
						                    '<input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> '+
						                    '<div class="form-group"> ' +
						                    '<div class="col-sm-12">' +
						                    '<a class="btn-primary" style="float:right; color: white; padding: 15px; margin-right: 10px" href="<?php echo e(route("EAC")); ?>"> Télécharger le fichier à remplir </a>' +
						                    '</div> ' +
						                    '</div> ' +
						                    ' <div class="form-group"> ' +
						                    '<div class="col-sm-12"> ' +
                    ...
                    if(id.substr(-4, 4) == "actv"){
	            	    ...
	            	    if(json.statut == '0')
                			div.innerHTML = '' +
	                            ...
	                            '</div>' +
	                            '<div class="modal-body">' +
	                            '   <form class="form-horizontal" method="post" action="<?php echo e(route("SADC")); ?>">' +
	                            '      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
	                            '      <input type="hidden" name="codeagent" value="'+json.Agent+'" />' +
	                            '      <div class="form-group">  ' +
