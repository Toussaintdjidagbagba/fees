	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<?php if(in_array("add_niv", session("auto_action"))): ?>   
					...
					<script>		
						...
						y.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "<?php echo e(route('listN')); ?>?check="+search+"&rec=1", true);
							xhr.send(null);
					...
					<div class="table-responsive" data-pattern="priority-columns">
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody id="data">
								...
								<?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
								<tr>
									<th><span class="co-name"><?php echo e($niveau->codeNiveau); ?></span></th>
									<td><?php echo e($niveau->libelleNiveau); ?></td>
									<td><?php echo e(App\Providers\InterfaceServiceProvider::LibelleUser($niveau->user_action)); ?></td>
									<td>
                                    <?php if(in_array("update_niv", session("auto_action"))): ?>
									<button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"> <a href="/modif-niveaux-<?php echo e($niveau->codeNiveau); ?>" style="color:white;"><i class="ico fa fa-edit"></i></a>
									</button>
									<?php endif; ?>

									<?php if(in_array("delete_niv", session("auto_action"))): ?>
									<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="/delete-niveaux-<?php echo e($niveau->codeNiveau); ?>" style="color:white;"><i class="ico fa fa-trash"></i></a> </button>
									</td>
									<?php endif; ?>
								</tr>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="post" action="<?php echo e(route('AddN')); ?>">
							<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
							<div class="form-group">
