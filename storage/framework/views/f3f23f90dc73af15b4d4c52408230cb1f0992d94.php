		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">   
					<?php if(in_array("add_role", session("auto_action"))): ?>
					...
					<script>		
						...
						y.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "<?php echo e(route('listR')); ?>?check="+search+"&rec=1", true);
							xhr.send(null);
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="post" action="<?php echo e(route('AddR')); ?>">
							<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
							<div class="form-group">
