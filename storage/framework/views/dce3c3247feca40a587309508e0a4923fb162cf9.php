...
<?php if(in_array("add_equipe", session("auto_action"))): ?>
			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="<?php echo e(route('AddE')); ?>"  enctype="multipart/form-data">
					...
					<script>		
						...
						y.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "<?php echo e(route('listE')); ?>?check="+search+"&rec=1", true);
							xhr.send(null);
