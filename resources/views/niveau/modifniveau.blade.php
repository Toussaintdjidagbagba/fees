		...
		<div class="box-content bordered info js__card">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="{{ route('ModifN') }}" >
							...
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="hidden" name="id" value="{{ $info->codeNiveau }}" />
										<input type="text" class="form-control" id="inp-type-1" value="{{ $info->libelleNiveau }}" name="libelle" >
									</div>
							    </div>
