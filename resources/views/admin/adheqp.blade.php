		...
		<div class="box-content bordered info js__card">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="{{ route('SAdhC') }}" enctype="multipart/form-data"  >
						...
						<div class="col-sm-6">
								...
								<table id="myTable">
									...
									@forelse($allequipe as $eqp)
										<tr>
									  	<td><input type= "radio" name="equipeselect" value="{{ $eqp->codeH }}" required></td>
									    <td>{{ $eqp->codeH }}</td>
