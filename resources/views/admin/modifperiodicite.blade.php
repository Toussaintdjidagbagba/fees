					...
					<form class="form-horizontal" method="post" action="{{ route('ModifP') }}" >
							...
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="hidden" name="id" value="{{ $info->idPeriodicite }}" />
										<input type="text" class="form-control" id="inp-type-1" value="{{ $info->libelle }}" name="libelle" required>
									</div>
							    </div>
							</div>
