		...
		<div class="box-content bordered info js__card">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="{{ route('GES') }}" enctype="multipart/form-data" >
							...
							@endif
								...
								<table id="myTable">
									<tr>
										<th></th>
										<th>
											@if($type == "CEQP") Code Inspection @endif
											@if($type == 'CONS') Code Equipe @endif
											@if($type == "INS" || $type == "BD" || $type == "BDS" || $type == "APL") Code Région @endif
										</th>
										<th>
											@if($type == "CEQP") Nom Chef Inspection @endif
											@if($type == 'CONS') Nom Chef Equipe @endif
											@if($type == "INS" || $type == "BD" || $type == "BDS" || $type == "APL") Nom Chef Région @endif
										</th>
									</tr>
									@forelse($all as $eqp)
										<tr>
									  	<td><input type= "radio" name="insselect" value="{{ $eqp->codeH }}" required></td>
									    <td>{{ $eqp->codeH }}</td>
