...
@section('content')
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content text-white" style="background: #D19C0A ">
					<div class="statistics-box with-icon">
						...
						<h2 class="counter" style="margin-left:-80px; margin-top:20px; font-size:20px">{{number_format($allCommission, 0, '.', ' ')}} CFA</h2>
					</div>
				</div>
				<!-- /.box-content -->
			</div>
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content text-white" style="background: #f2b200; ">
					<div class="statistics-box with-icon">
						...
						<h2 class="counter" style="margin-left:-80px; margin-top:20px; font-size:20px">{{number_format($derniere, 0, '.', ' ')}} CFA</h2>
					</div>
				</div>
				<!-- /.box-content -->
			</div>
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="box-content text-white" style="background:  #D19C0A ">
					<div class="statistics-box with-icon">
						...
						<h2 class="counter" style="margin-left:-80px; margin-top:20px; font-size:20px">{{$allCom}}</h2>
					</div>
				</div>
				<!-- /.box-content -->
			</div>
		    ...
		    <div class="col-lg-12 col-md-12 col-xs-12">
		     ...
		     <section class="step-wizard">
                <ul class="step-wizard-list">
                    @if(App\Providers\InterfaceServiceProvider::niveauVal(-1) == 1 && App\Providers\InterfaceServiceProvider::niveauVal(-1) != 3)
                        <li class="step-wizard-item current-item">
                    @else
                        @if(date('d-m') > date('01-m') && date('d-m') <= date('26-m'))
                            @if(App\Providers\InterfaceServiceProvider::niveauVal(-1) != 1 && 
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauVal(0) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauVal(2) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item ">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauVal(3) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item ">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauVal(4) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item ">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauVal(5) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauVal(6) == 1)
                        <li class="step-wizard-item ">
                    @else
		...
		<div class="row small-spacing">
		    <div class="col-lg-12 col-md-12 col-xs-12">
		     ...
		     <section class="step-wizard">
                <ul class="step-wizard-list">
                    @if(App\Providers\InterfaceServiceProvider::niveauValG(-1) == 1 && App\Providers\InterfaceServiceProvider::niveauValG(-1) != 3)
                        <li class="step-wizard-item current-item"> 
                    @else
                        
                        @if(App\Providers\InterfaceServiceProvider::niveauValG(-1) != 1 && 
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauValG(0) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauValG(2) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item ">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauValG(3) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item ">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauValG(4) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                        <li class="step-wizard-item ">
                    @endif
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauValG(5) == 1)
                        <li class="step-wizard-item current-item">
                    @else
                    ...
                    @if(App\Providers\InterfaceServiceProvider::niveauValG(6) == 1)
                        <li class="step-wizard-item ">
                    @else
