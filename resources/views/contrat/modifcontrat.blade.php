		...
		<div class="box-content bordered info js__card">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="{{ route('ModifContrat') }}" >
							<input type="hidden" name="_token" value="{{ csrf_token() }}" />
                            <input type="hidden" name="id" value="{{ $info->police }}" />
							...
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="date" class="form-control" id="inp-type-1" value="{{ DateTime::createFromFormat('d-m-Y', $info->DateDebutEffet)->format('Y-m-d') }}" name="dde"  >
									</div>
							    </div>
							    <div class="col-sm-6">
									<label for="inp-type-1" style="vertical-align:middle; margin-top: 1%;" class="col-sm-12  ">Date fin Effet : </label>
									<div class="col-sm-12">
										<input type="date" class="form-control" id="inp-type-1" value="{{ DateTime::createFromFormat('d-m-Y', $info->DateFinEffet)->format('Y-m-d') }}" name="dfe"  >
									</div>
							    </div>
							</div>
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1" value="{{ $info->statutSunshine }}" name="sta"  >
									</div>
							    </div>
							    <div class="col-sm-6">
