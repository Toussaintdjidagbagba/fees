		...
		<div class="box-content bordered info js__card">
			...
			<div class="col-xs-12">
				...
				<div class="box-content">
					...
					<form class="form-horizontal" method="post" action="{{ route('ModifI') }}" enctype="multipart/form-data" >
              ...
              <input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> <!-- Limite 5Mo -->              
							...
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1"  name="ville" value="{{ $infoins->villeH }}">
									</div>
							    </div>
							    <div class="col-sm-6">
								...
								<div class="col-sm-12">
									<select type="number" class="chosen form-control" id="inp-type-1" name="manageur" >
										<option value="{{$infoins->managerH}}"> {{App\Providers\InterfaceServiceProvider::infomanageur($infoins->managerH)}}</option>
