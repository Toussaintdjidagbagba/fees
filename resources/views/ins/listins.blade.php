...
@if(in_array("add_insp", session("auto_action")))
			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="{{ route('addi') }}" enctype="multipart/form-data" >
					...
					<script>		
						...
						y.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "{{route('listI')}}?check="+search+"&rec=1", true);
							xhr.send(null);
							...
							<tbody id="data">
								...
								<tr>
									...
									<button type="button" title="Mutation"  class="btn btn-success btn-circle btn-xs  margin-bottom-10 waves-effect waves-light">
									    <a href="{{route('GMutationI', $ins->codeH)}}" style="color:white;"><i class="ico fa fa-mail-forward"></i> </a>
									</button>
									@endif
