		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">  
					...
					<form class="form-horizontal" action="{{route('listdocumentset')}}" method="post">
						...
						<div class="form-group">
							<div class="col-sm-3" style="margin-left: 40px;">
								...
								<input class="form-control" type="month" name="check" value="" min="2021-12" max="{{date('Y-m', strtotime('-1 month'))}}">
	            ...
	            if (id != 0) {
	            	...
	            	if(id.substr(-4, 4) == "renv"){
                    	...
                    	div.innerHTML = '<div class="modal-header">' +
                            ...
                            '   <form class="form-horizontal" method="post" action="{{ route("RFPC") }}">' +
	                        '      <input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
