		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					<!------------------------------------------>
					<form class="form-horizontal" action="{{route('GCT')}}" method="GET" id="recherche">
                    ...
                    <!------------------------------------------->
					<form class="form-horizontal" method="post" action="{{ route('SCT') }}" id="regle">
										<input type="hidden" name="_token" value="{{ csrf_token() }}" />
					...
					<a class="btn-warning dropdown-item " id="valid" href="{{ route('GRT') }}"
						...
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td style="vertical-align:middle; text-align: center;">{{$comp->compte}} CFA</td>
	    ...
	    $(function () {
            ...
            if(id.substr(-4, 4) == "reje"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '<form class="form-horizontal" method="post" action="{{ route("RCT") }}">' +
                        '<input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
