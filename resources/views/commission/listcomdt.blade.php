		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					<div id="ref">
						Ref <b style="color:#001e60">SP <img src="{{ $signaturesp }}" id="signataire"></b>/<b style="color:#001e60">CSP <img src="{{ $signaturecsp }}" id="signataire"> </b>/<b style="color:#001e60">DT</b>/{{$sigle}}
					</div>
					@if(in_array("confirm_dt_com", session("auto_action")))
					...
					<a class="btn-danger dropdown-item autrecom" id="valid" href="#autrCom"
					   ...
					   @endif
					<a class="btn-primary dropdown-item" style="float: right; margin-right: 10px" href="{{ route('GEDREXCEL') }}">Etat commission </a>
					<a class="btn-primary dropdown-item" style="float: right; margin-right: 10px" href="{{ route('GEDREXCEL') }}">Etat détail </a>
					   <!------------------------------------------>
					<!--form class="form-horizontal" action="{{route('GCDT')}}" method="GET" id="recherche">
	    ...
	    $(function () {
			...
			if(id.substr(-4, 4) == "reje"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '<form class="form-horizontal" method="post" action="{{ route("RCDT") }}">' +
                        '<input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
