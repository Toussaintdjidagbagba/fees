	...
	<div class="col-lg-12 col-md-12 col-xs-12"> 
		...
		<div class="box-content bordered info js__card">
			...
			<h4 class="box-title with-control">
			 Détails des Commissions de  {{ $nomapp }} ( {{ view()->shared('periodelettre') }} ) : 
			<span class="controls">
				        ...
				        <div class="box-content" >
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->tauxCarec , 0, '.', ' ')." %" }}"></div>
							    </div>
							    <div class="col-sm-6">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->montantAmical , 0, '.', ' ') }}  CFA"></div>
							    </div>
							</div>
							...
							<div class="form-group">
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->compteMoisCalculer), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->compteEncadrementMoisCalculer), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->AutreCommissionMoisCalculer), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->bonus), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
							...
							<div class="form-group">
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->fixe), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->compteBloquer), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
								<div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->dotationTelephonie), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format(($compte->dotationCarburant), 0, '.', ' ')." CFA" }}"> </div>
							    </div>
							...
							<div class="form-group">
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->avancesancien , 0, '.', ' ') }}  CFA"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->recentrembourcer , 0, '.', ' ') }}  CFA"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->anticiper , 0, '.', ' ') }}"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->duree , 0, '.', ' ') }}"></div>
							    </div>
							</div>
							<div class="form-group">
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->aibMoisCalculer, 0, '.', ' ') }} CFA"></div>
							    </div>
							    <div class="col-sm-3">
									...
									<div class="col-sm-12"> 
									<input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->retenue , 0, '.', ' ') }} CFA"></div>
							    </div>
							    <div class="col-sm-3">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->traceCarec , 0, '.', ' ') }}  CFA"></div>
							    </div>
								<div class="col-sm-3">
								    <label for="inp-type-1" style="vertical-align:middle; margin-top: 1%; font-size: 14px; font-weight: bold;" class="col-sm-12">Montant Amical : </label>
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->tracesAmical , 0, '.', ' ') }}  CFA"></div>
							    </div>
							...
							<div class="form-group">
							    <div class="col-sm-12">
								    ...
								    <div class="col-sm-12"> 
								    <input type="text" class="form-control" id="inp-type-1"  value="{{ number_format( $compte->compte , 0, '.', ' ')." CFA" }}"></div>
							    </div>
						...
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped" style="font-size: 10px;">
							...
							<tbody id="data">
								...
								@if($niveau <> "CONS")
    								...
    								@endforelse
    								@foreach($detailComA as $comma)
    							        @if( strtotime($comma->DateDebutEffet) < strtotime("01-01-2023")  )
            							    <tr>
            							        <th data-priority="1" style="vertical-align:middle; text-align: center;"><a href="{{ route('GetDetailContrat', $comma->NumPolice) }}"> {{ $comma->NumPolice }} </a></th>
            									<th data-priority="1" style="vertical-align:middle; text-align: center;">{{ $comma->Client}}</th>
            									<th data-priority="1" style="vertical-align:middle; text-align: center;"><a href="{{ route('GetDetailQuittance', $comma->NumQuittance) }}">{{ $comma->NumQuittance }} </a></th>
            									<th data-priority="1" style="vertical-align:middle; text-align: center;">{{ $comma->Statut }}</th>
            									<th data-priority="1" style="vertical-align:middle; text-align: center;">{{ $niveaua}}</th>
            									<th data-priority="1" style="vertical-align:middle; text-align: center;">{{ number_format($comma->BaseCommission , 0, '.', ' ')}}</th>
            									<?php 
