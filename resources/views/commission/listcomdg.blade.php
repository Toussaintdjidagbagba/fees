		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">
					<div id="ref">
						Ref <b style="color:#001e60">SP <img src="{{ $signaturesp }}" id="signataire"></b>/<b style="color:#001e60">CSP <img src="{{ $signaturecsp }}" id="signataire"> </b>/<b style="color:#001e60">DT  <img src="{{ $signaturedt }}" id="signataire"> </b>/ <b style="color:#001e60">DG</b>/{{$sigle}}
					</div>
					@if(in_array("confirm_dg_com", session("auto_action")))
					...
					@endif
					<!------------------------------------------>
					<!--form class="form-horizontal" action="{{route('GCDG')}}" method="GET" id="recherche">
	    ...
	    $(function () {
            ...
            if(id.substr(-4, 4) == "reje"){
                ...
                div.innerHTML = '<div class="modal-header">' +
                    ...
                    '<form class="form-horizontal" method="post" action="{{ route("RCDG") }}">' +
                        '<input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
