			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
                    <form class="form-horizontal" method="post" action="{{ route('GRTSG') }}" id="vue">
                        ...
                        <div class="form-group">
								<div class="col-sm-5">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1" value="{{session('qrg')}}" name="qr" id="qr" required>
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="inp-type-2" value="{{session('montallg')}}" name="mont" readonly>
								</div>
								<div class="col-sm-2">
			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="{{ route('SRTG') }}">
							<input type="hidden" name="_token" value="{{ csrf_token() }}" />
							<input type="hidden" value="{{session('qrg')}}" name="qr">
					...
					<div class="table-responsive" data-pattern="priority-columns">
						<table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
							...
							<tbody>
								...
								@if(session('allreglementg') != "")
									@foreach(session('allreglementg') as $reglement)
									<tr>
									...
									<th data-priority="6"><center>
										<button type="button" title="Supprimer"  class="btn btn-danger btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="/delete-reglementgroupe-{{$reglement->idReglement}}" style="color:white;"><i class="ico fa fa-trash"></i></a> </button>
									</center></th>
								</tr>
									@endforeach
								@endif
