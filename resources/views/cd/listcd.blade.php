...
@if(in_array("add_coordination", session("auto_action")))
			...
			<div class="js__card_content">
			 ...
			 <div class="col-xs-12">
				<div class="box-content" >
					...
					<form class="form-horizontal" method="post" action="{{ route('addCd') }}"  enctype="multipart/form-data" >
					...
					<script>		
						...
						y.addEventListener("blur", function () {
						  ...
						  var xhr = getXMLHttpRequest(); 
							xhr.open("GET", "{{route('listCd')}}?check="+search+"&rec=1", true);
							xhr.send(null);
							...
							<tbody id="data">
								...
								<tr>
									<th style="text-align: center; vertical-align:middle;">
										<span class="co-name">{{$cd->codeH}}</span>
									</th>
									...
									<td style="text-align: center; vertical-align:middle;"  
										title="{{ App\Providers\InterfaceServiceProvider::infomanageur($cd->managerH) }}">
									    {{$cd->managerH}}
								    </td>
									
									<td style="text-align: center; vertical-align:middle;">{{$cd->villeH}}</td>
									<td style="text-align: center; vertical-align:middle;">{{App\Providers\InterfaceServiceProvider::LibelleUser($cd->user_action)}}</td>
									<td style="text-align: center; vertical-align:middle;">
										@if(in_array("update_coordination", session("auto_action")))
									<button type="button" title="Modifier"  class="btn btn-primary btn-circle btn-xs  margin-bottom-10 waves-effect waves-light"><a href="/modif-cd-{{$cd->codeH}}" style="color:white;"><i class="ico fa fa-edit"></i> </a>
									</button>
									@endif
