		...
		<div class="box-content bordered info js__card">
			...
			<div class="js__card_content">
				...
				<div class="row small-spacing">   
					...
					<button type="button" style="float:right;" class="btn btn-icon btn-icon-right btn-warning btn-sm waves-effect waves-light"><a href="{{ route('listG') }}"><i class="ico fa fa-mail-reply"></i>Retour</a></button>
			<div class="col-xs-12">

				<div class="box-content">
					
					<form class="form-horizontal" method="post" action="{{ route('ModifG') }}" enctype="multipart/form-data"  >
              ...
              <input type="hidden" name="MAX_FILE_SIZE" value="5242880" /> <!-- Limite 5Mo -->              
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="hidden"  name="codeh" value="{{ $inforg->codeH }}">
										<input type="text" class="form-control" id="inp-type-1"  name="codeh" value="{{ $inforg->codeH }}" disabled="true">
									</div>
							    </div>
								<div class="col-sm-6">
								<label for="inp-type-1" style="vertical-align:middle; margin-top: 1%;" class="col-sm-12">Libellé : </label>
								<div class="col-sm-12">
									<input type="text" class="form-control" id="inp-type-1"  name="lib" value="{{ $inforg->libelleH }}">
								</div>
							    </div>			
							</div>
							<div class="form-group">
								<div class="col-sm-6">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" id="inp-type-1"  name="ville" value="{{ $inforg->villeH }}">
									</div>
							    </div>
							    <div class="col-sm-6">
								...
								<div class="col-sm-12">
									<select type="number" class="chosen form-control" id="inp-type-1" name="manageur" >
										<option value="{{$inforg->managerH}}"> {{App\Providers\InterfaceServiceProvider::infomanageur($inforg->managerH)}}</option>
										@foreach($listmag as $mag)
										@if($mag->codeCom != $inforg->managerH )
							    ...
							    <div class="col-sm-6">
									...
									<div class="col-sm-12">
										<select type="text" class=" chosen form-control" id="inp-type-1" name="sup" >
											<option value="{{$inforg->superieurH}}"> {{App\Providers\InterfaceServiceProvider::infosup($inforg->superieurH)}} </option>
											@foreach($listsup as $sup)
											@if($sup->codeH != $inforg->superieurH)
